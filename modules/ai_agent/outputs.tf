...
resource "aws_ssm_parameter" "rds_cluster_arn" {
  ...
  name     = "${local.output_prefix}/aws_rds_cluster_arn"
  type     = "String"
...
resource "aws_ssm_parameter" "rds_cluster_id" {
  provider = aws.primary
  name     = "${local.output_prefix}/aws_rds_cluster_id"
  type     = "String"
...
resource "aws_ssm_parameter" "rds_cluster_primary_instance_arn" {
  provider = aws.primary
  name     = "${local.output_prefix}/aws_rds_cluster_primary_instance_arn"
  type     = "String"
...
resource "aws_ssm_parameter" "rds_cluster_primary_instance_id" {
  provider = aws.primary
  name     = "${local.output_prefix}/aws_rds_cluster_primary_instance_id"
  type     = "String"
...
resource "aws_ssm_parameter" "rds_cluster_writer_domain" {
  provider = aws.primary
  name     = "${local.output_prefix}/aws_rds_cluster_writer_domain"
  type     = "String"
...
resource "aws_ssm_parameter" "rds_cluster_reader_domain" {
  provider = aws.primary
  name     = "${local.output_prefix}/aws_rds_cluster_reader_domain"
  type     = "String"
