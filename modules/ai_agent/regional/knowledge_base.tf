...
# #-------------------------------------------------------------------------------
# # Create index for OpenSearch Serverless collection
# # TODO consider converting this to Aurora PostgreSQL
# #-------------------------------------------------------------------------------

provider "opensearch" {
  url         = "https://kysb8v8u5fgum8yxgoi1.us-east-1.aoss.amazonaws.com" #aws_opensearchserverless_collection.knowledge_base.collection_endpoint
  healthcheck = false
}
